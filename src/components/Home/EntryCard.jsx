...
const EntryCard = ({ entry, onEdit, onDelete }) => {
  return (
    <div className="flex max-w-sm rounded-[32px] overflow-hidden bg-white-coco dark:bg-metal shadow-3xl w-full p-4">
      <img src={entry.image} alt={entry.title} className="h-24 object-cover" />
